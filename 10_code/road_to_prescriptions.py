...
df["BUYER_COUNTY"] = np.where(df["BUYER_ADDRESS1"] == "1000 FIRST AVE NE", "GRADY", 0)


# %%
df[df["BUYER_COUNTY"].isnull()]
...
df4["BUYER_COUNTY"] = df4["BUYER_COUNTY"].fillna("PINELLAS")
...
prescriptions2.to_csv(
    "/Users/clarissaache/IDS720/spaceX/pds2021-opioids-team-three/20_intermediate/prescriptions2"
)
